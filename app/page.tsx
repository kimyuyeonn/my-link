      ...
      <div className="w-full max-w-md flex flex-col gap-10 mt-12 z-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="flex flex-col items-center text-center relative group">
          <div className="absolute top-0 right-4 sm:right-0">
            <Button variant="ghost" size="icon" className="rounded-full bg-white/50 dark:bg-black/20 backdrop-blur-md hover:bg-white/80 dark:hover:bg-black/40 text-slate-700 dark:text-slate-300 transition-all">
            ...
            return (
              ...
              >
                <Card className="relative flex items-center p-4 min-h-[64px] transition-all duration-300 ease-out 
                  ...
                  {/* Icon Container - Absolute positioned to the left */}
                  <div className="absolute left-2 sm:left-4 flex items-center justify-center w-12 h-12 rounded-xl bg-slate-100/80 dark:bg-slate-800/80 text-slate-700 dark:text-slate-300 group-hover:bg-purple-100 dark:group-hover:bg-purple-500/20 group-hover:text-purple-600 dark:group-hover:text-purple-400 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-sm">
                    {Icon}
                  </div>
        ...
        <div className="mt-8 mb-4 text-center">
          <Link href="/" className="inline-flex items-center gap-2 text-sm font-bold text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 transition-colors">
            <div className="w-5 h-5 rounded bg-slate-300 dark:bg-slate-700 flex items-center justify-center text-[10px] text-white">M</div>
            MyLink
          </Link>
        </div>
      </div>
